    ...
    <a-modal v-model="isAddVisible" class="addContractModal" width="80%" :title="isShowEdit ? '编辑合同': '新增合同'" ok-text="确认" cancel-text="取消" @ok="handleSubmitModalClick" @cancel="handleCancelClick" :confirmLoading="confirmLoading">
      ...
      >
        <div>
            ...
            <a-row :gutter="24">
                 <a-col :span="12" v-if="companyType == '8' || companyType == '12'|| companyType == '11'|| companyType == '7'|| companyType == '9'">
        ...
        <div>
            ...
            <a-row :gutter="24">
                <a-col :span="12">
                    ...
                    <a-input 
                        type="text" 
                        v-model="addForm.projectIDLv3Name"
                        disabled
                    />
                    </a-form-model-item>
                </a-col>
        ...
        <div>
            ...
            <a-row :gutter="24">
                <a-col :span="12">
                    <a-form-model-item label="合同质保金比例（%）" prop="contractRetentionRatio">
                    <a-input 
                        type="number" 
                        v-model="addForm.contractRetentionRatio"
                        placeholder="合同质保金比例（%）"
                    />
                    </a-form-model-item>
                </a-col>
                <a-col :span="12">
                    <a-form-model-item label="合同预付款比例（%）" prop="contractAdvancePaymentRatio">
                    <a-input 
                        type="number" 
                        v-model="addForm.contractAdvancePaymentRatio"
                        placeholder="合同预付款比例（%）"
                    />
                    </a-form-model-item>
                </a-col>
        ...
        <div>
            ...
            <a-row :gutter="24"  v-if="companyType == '8' || companyType == '12'|| companyType == '11'|| companyType == '7'|| companyType == '9'">
                <a-col :span="12">
        ...
        <div>
            ...
            <div v-if="companyType == '8' || companyType == '12'|| companyType == '11'|| companyType == '7'|| companyType == '9'">
                <a-row :gutter="24">
                  <a-col :span="12">
    ...
    <a-modal v-model="isDetailVisible" class="addContractModal" width="80%" title="详情" :footer="null">
        ...
        <div>
            ...
            <a-row :gutter="24" class="model-col">
                <a-col :span="12">
                    <span>合同质保金比例（%）：</span>
                    <span>{{ contractDetail.contractRetentionRatio }}%</span>
                </a-col>
                <a-col :span="12">
                    <span>合同预付款比例（%）：</span>
                    <span>{{ contractDetail.contractAdvancePaymentRatio }}%</span>
                </a-col>
            </a-row>
            <!-- <a-row :gutter="24" class="model-col">
                <a-col :span="12">
...
import { getContractList, addContractInfo, getContractTypeAll, getGeneralContract, getThirdProject, getUserRole, getContractDetail, editContractInfo, getThirdPrjName, getDownloadFile, getCompanyCreditCode, getContractTypeByscene, getCompanySelf } from '@/api/contract'
...
//   },
  ...
  methods: {
    ...
    getContractTypeSelect () {
      getContractTypeByscene(2).then(res => {
        if(res && res.length > 0) {
   ...
   handleSearchClick() {
    ...
    handleAddClick() {
      ...
      this.addForm = {
        contractCreate: this.companyType == '8' || this.companyType == '12'|| this.companyType == '11'|| this.companyType == '7'|| this.companyType == '9' ? '2': '1',
        contractType: [],
        belongContractCode: undefined,
        belongProjectCode: localStorage.getItem('projectIDLv3'),
        projectIDLv3Name: localStorage.getItem('projectName'),
    ...
    handleEditClick(row) {
      ...
      getContractDetail(row.id).then(async res => {
        ...
        this.addForm.belongProjectName = data.belongProjectName
    ...
    handlePayerNameFocus() {
      ...
      if (this.companyType == '8' || this.companyType == '12'|| this.companyType == '11'|| this.companyType == '7'|| this.companyType == '9') {
