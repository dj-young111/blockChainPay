<template>
    <page-header-wrapper>
        ...
        <a-modal v-model="isAddVisible" width="80%" class="addContractTodoModal" :footer="null">
            <div class="model-row">
                <span>当前进度</span>
            </div>
        ...
        <a-modal v-model="isPayVisible" width="80%" class="addContractTodoModal" title="审批详情" :footer="null">
            <div class="model-row">
                <span>当前进度</span>
            </div>
        ...
        <a-modal v-model="isLogVisible" width="80%" class="addContractTodoModal" title="审批日志" :footer="false">
        ...
        <a-modal v-model="isPayLogVisible" width="80%" class="addContractTodoModal" title="审批日志" :footer="false">
            <div class="contract-log-wrapper">
        ...
        <a-modal v-model="isPayDetailVisible" width="80%" class="addContractTodoModal" title="明细详情" :footer="false">
        ...
        <!-- 支付补录详情 -->
        <a-modal v-model="isCollectionVisible" width="80%" class="addContractTodoModal" title="支付补录详情" :footer="null">
            <div class="model-row">
                <span>基本信息</span>
            </div>
            <a-row :gutter="24" class="model-col">
